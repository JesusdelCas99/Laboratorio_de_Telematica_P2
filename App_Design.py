...
def Paso2(): 
    ...
    if dim==0:
        ...
        dlg8.close() #Cerramos la ventana principal
...
def Imagen():
    ...
    Nc=dlg.lineEdit.text()
    NI=dlg.lineEdit_2.text()
    Bandwidth=dlg.lineEdit_3.text()
    P_Enlace=dlg.comboBox_4.currentText()
    ...
    dlg8.label_8.setText('Línea ' + NI )
    dlg8.label_12.setText('Línea ' + NI )
    dlg8.label_9.setText('Cliente ' + Nc )
    dlg8.label_16.setText('PBX_Cliente ' + Nc )
    dlg8.label_18.setText(Bandwidth + ' Mbps' )
    dlg8.label_19.setText('Enlace ' + P_Enlace)
...
dlg8=uic.loadUi("ArquitecturaRed.ui")
...
dlg8.pushButton.clicked.connect(Paso2) 
